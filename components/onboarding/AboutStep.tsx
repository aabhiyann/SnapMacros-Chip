    ...
    return (
        <div className="flex-1 flex flex-col pt-[120px] pb-[160px] px-[20px] overflow-y-auto relative">
            ...
            <div className="flex flex-col gap-5 flex-1 pb-8">
                ...
                {/* Name */}
                <div>
                    <label className="block text-[#9898B3] text-[11px] font-bold uppercase mb-2 ml-1 tracking-wider">
                    ...
                    <input
                        ...
                        className="w-full bg-[#13131C] border border-[#2A2A3D] rounded-[16px] h-[52px] px-5 text-white font-['DM_Sans'] text-[16px] focus:outline-none focus:border-[#4F9EFF] transition-colors"
                    />
                    {isNameInvalid && localData.name !== data.name && (
                        <p className="text-[#4F9EFF] text-[12px] font-['DM_Sans'] mt-2 ml-1">Chip needs something to call you!</p>
                    )}
                </div>

                {/* Age Stepper */}
                <div>
                    <label className="block text-[#9898B3] text-[11px] font-bold uppercase mb-2 ml-1 tracking-wider">AGE</label>
                    <div className={`flex items-center justify-between bg-[#13131C] border ${isAgeInvalid ? 'border-[#4F9EFF]' : 'border-[#2A2A3D]'} rounded-[16px] p-2 h-[52px] transition-colors`}>
                    ...
                    {isAgeInvalid && (
                        <p className="text-[#4F9EFF] text-[12px] font-['DM_Sans'] mt-2 ml-1">Age must be between 13 and 85</p>
                    )}
                </div>

                {/* Weight Grid */}
                <div>
                    <label className="block text-[#9898B3] text-[11px] font-bold uppercase mb-2 ml-1 tracking-wider">WEIGHT</label>
                    <div className="flex gap-2">
                        <input
                            ...
                            placeholder="0"
                            className={`flex-1 bg-[#13131C] border ${isWeightInvalid ? 'border-[#4F9EFF]' : 'border-[#2A2A3D]'} rounded-[16px] h-[52px] px-5 text-center text-white font-['Bricolage_Grotesque'] font-bold text-[22px] focus:outline-none focus:border-[#4F9EFF] transition-colors`}
                        />
                        <div className="bg-[#13131C] border border-[#2A2A3D] rounded-[16px] p-1 flex h-[52px]">
                            <TapButton
                                onClick={() => handleWeightUnitToggle("kg")}
                                className={`px-4 flex items-center justify-center rounded-[12px] font-bold text-[13px] ${localData.weightUnit === "kg" ? "bg-[#4F9EFF] text-white" : "text-[#56566F] hover:bg-[#22222F]"}`}
                            >KG</TapButton>
                            <TapButton
                                onClick={() => handleWeightUnitToggle("lbs")}
                                className={`px-4 flex items-center justify-center rounded-[12px] font-bold text-[13px] ${localData.weightUnit === "lbs" ? "bg-[#4F9EFF] text-white" : "text-[#56566F] hover:bg-[#22222F]"}`}
                            >LBS</TapButton>
                        </div>
                    </div>
                    {isWeightInvalid && (
                        <p className="text-[#4F9EFF] text-[12px] font-['DM_Sans'] mt-2 ml-1">Weight must be between 30 and 350kg</p>
                    )}
                </div>

                {/* Height Grid */}
                <div>
                    <label className="block text-[#9898B3] text-[11px] font-bold uppercase mb-2 ml-1 tracking-wider">HEIGHT</label>
                    <div className="flex gap-2">
                        {localData.heightUnit === "cm" ? (
                            <input
                                ...
                                placeholder="175"
                                className="flex-1 bg-[#13131C] border border-[#2A2A3D] rounded-[16px] h-[52px] px-5 text-center text-white font-['Bricolage_Grotesque'] font-bold text-[22px] focus:outline-none focus:border-[#4F9EFF] transition-colors"
                            />
                        ) : (
                            <div className="flex-1 flex gap-2">
                                <div className="flex-1 relative">
                                    <input
                                        ...
                                        placeholder="5"
                                        className="w-full bg-[#13131C] border border-[#2A2A3D] rounded-[16px] h-[52px] pr-8 pl-2 text-center text-white font-['Bricolage_Grotesque'] font-bold text-[22px] focus:outline-none focus:border-[#4F9EFF] transition-colors"
                                    />
                                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[#56566F] font-bold">&apos;</span>
                                </div>
                                <div className="flex-1 relative">
                                    <input
                                        type="number" inputMode="numeric" pattern="[0-9]*"
                        ...
                        <div className="bg-[#13131C] border border-[#2A2A3D] rounded-[16px] p-1 flex h-[52px]">
                            <TapButton
                                ...
                                className={`px-4 flex items-center justify-center rounded-[12px] font-bold text-[13px] ${localData.heightUnit === "cm" ? "bg-[#4F9EFF] text-white" : "text-[#56566F] hover:bg-[#22222F]"}`}
                            >CM</TapButton>
                            <TapButton
                                onClick={() => handleHeightUnitToggle("ft")}
                                className={`px-4 flex items-center justify-center rounded-[12px] font-bold text-[13px] ${localData.heightUnit === "ft" ? "bg-[#4F9EFF] text-white" : "text-[#56566F] hover:bg-[#22222F]"}`}
                            >FT</TapButton>
                        </div>
                    </div>
                </div>
                ...
                {/* Gender */}
                <div>
                    <label className="block text-[#9898B3] text-[11px] font-bold uppercase mb-1 ml-1 tracking-wider">BIOLOGICAL SEX</label>
                    <p className="text-[10px] text-[#56566F] mb-2 ml-1">(Used only for metabolism calculation)</p>
                    <div className="flex gap-2">
                        <TapButton
                            onClick={() => setLocalData(prev => ({ ...prev, gender: "male" }))}
                            className={`flex-1 h-[52px] rounded-[16px] font-bold text-[14px] transition-colors ${localData.gender === "male" ? "bg-[#4F9EFF] text-white" : "bg-[#13131C] border border-[#2A2A3D] text-[#9898B3] hover:bg-[#22222F]"}`}
                        >Male</TapButton>
                        <TapButton
                            onClick={() => setLocalData(prev => ({ ...prev, gender: "female" }))}
                            className={`flex-1 h-[52px] rounded-[16px] font-bold text-[14px] transition-colors ${localData.gender === "female" ? "bg-[#4F9EFF] text-white" : "bg-[#13131C] border border-[#2A2A3D] text-[#9898B3] hover:bg-[#22222F]"}`}
                        >Female</TapButton>
                        <TapButton
                            onClick={() => setLocalData(prev => ({ ...prev, gender: "other" }))}
                            className={`flex-1 h-[52px] rounded-[16px] font-bold text-[14px] leading-tight transition-colors ${localData.gender === "other" ? "bg-[#4F9EFF] text-white" : "bg-[#13131C] border border-[#2A2A3D] text-[#9898B3] hover:bg-[#22222F]"}`}
